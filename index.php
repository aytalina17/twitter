							...
							<div class="col-10">
								<form method="GET" action="insert.php">
									<div class="col-12">
										...
										<textarea name="text" class="form-control" placeholder="Что нового?"></textarea>
					...
					<div class="bg-white pt-3 pb-3 pl-3 pr-3">
						...
						<form method="GET" action="insert1.php">
							...
							<div class="col-8 pb-3">
								<button type="" class="btn btn-primary">Твитнуть</button>
							</div>
						</form>
							...
							<div class="col-4">
								...
								<a href="">
									...
									<?php 
                                        ...
                                        echo "<img class='w-100 rounded-circle' src='".$result1["img"]."'>";
                                    ?>
